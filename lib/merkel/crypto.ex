defmodule Merkel.Crypto do
  ...
  def hash(str, type \\ @hash_type, apply \\ @hash_apply) do
  ...
  @spec hash1(String.t, nil | :atom, nil | :atom) :: String.t
  def hash1(str, type, apply) do
    case apply do
      :double ->
  ...
  @spec hash_concat(String.t | Node.t, String.t | Node.t) :: String.t
